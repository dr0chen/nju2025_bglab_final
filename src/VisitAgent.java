...
public class VisitAgent
{
    ...
    public static class VisitAgentMapper extends Mapper<Object, Text, Text, IntWritable> {
        @Override
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (matcher.find()) {
                ...
                context.write(new Text(http_user_agent), new IntWritable(1));
            }
        }
    }

    public static class VisitAgentReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
        @Override
    ...
    public static void main( String[] args ) throws Exception {
        ...
        job1.setMapperClass(VisitAgentMapper.class);
        job1.setReducerClass(VisitAgentReducer.class);
